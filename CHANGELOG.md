...
- В таблицу мобильных операторов добавлен **Т-Мобайл (Москва)**: узкий профиль как в приложении Amnezia (Jc=6, Jmin=10, Jmax=50 + DNS-мимик I1 + полный туннель), сверка через `diagnose --carrier=tmobile_us` (Discussion #45)
