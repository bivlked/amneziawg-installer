...
**v5.29.0** - релизы теперь подписаны и собираются атомарно, перечень поддерживаемых систем стал машинным, а гейт SHA-пинов проверяет то, что установщик действительно скачивает.
