...
- **Ошибка 404 при подключении PPA на Ubuntu 25.10 или 26.04.** С v5.13.0 установщик проверяет, отвечает ли PPA для кодового имени, и если нет, сам переключается на `noble`. Если у вас v5.12.x, обновите установщик.
