...
# init до grep не доходят и читаются как «маркера нет». До этой функции такой
# init не доходит: manage отказывает раньше в check_dependencies, а установщик
# на шаге 0 считает его отсутствующим.
