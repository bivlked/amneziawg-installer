...
_awg31_blocker_message() {
    ...
    case "$code" in
        ...
        tools_old)
            ...
            ;;
        not_implemented_yet)
            printf '%s' "Эта версия установщика (v${SCRIPT_VERSION}) профиль AmneziaWG 3.1 пока не выдаёт: окружение у вас подходит, дело не в вашей машине. Выход сейчас: --protocol=2.0."
            ;;
        internal_error)
