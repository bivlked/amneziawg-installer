...
# Поэтому после отказа идёт контрольная команда БЕЗ параметров третьей линии:
# прошла она - значит путь до интерфейса рабочий и дело в параметрах (вторая
# линия), не прошла - проверить не удалось.
#
