...
_awg31_module_probe() (
    ...
    if (( rc != 0 )); then
        ...
        # Своего ТЕСТА у неё действительно нет: на машине разработки файл нельзя
        # ни превратить в ссылку, ни сделать нечитаемым. Прежняя форма `-s` спрашивала только «не
