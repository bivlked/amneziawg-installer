...
2. **Этот адрес выдан клиентам как DNS:** `sudo bash /root/awg/manage_amneziawg.sh modify <имя> DNS "10.9.9.1"` для каждого клиента. Новые клиенты получают DNS по умолчанию (`1.1.1.1, 1.0.0.1`), для них команду нужно повторить.
