...
| ядро старее 6.7 (Debian 12 с 6.1) | закреплённый модуль из исходников | 2.0 |
| ARM64 / armhf | наш предсобранный пакет | 2.0 |
...
На ARM установщик сначала пробует предсобранный пакет и находит его под ваше ядро, поэтому до PPA дело не доходит вовсе. Предсобранные пакеты закреплены на 2.0.
...
### AmneziaWG 3.0 и ядра старше 6.7 (Debian 12) - v5.24.0
